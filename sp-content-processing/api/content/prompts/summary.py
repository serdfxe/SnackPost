...
<b>Задача:</b> Создай краткую выжимку из статьи в примерном формате:  
...
- Используй подзаголовки с эмодзи (🔥,❗️,👉 и т.д.)  
- Разбивай текст на короткие абзацы (1-3 предложения)
- Избегай большого сплошного текста
...
- Подписывать части поста как Основная часть, Призыв, Основная мысль, Главное (Вместо этого просто напиши саму мысль) и другие "не живые" варианты
- Писать несколько P.S., P.P.S.
- Использовать разделители ---
- Писать какой либо текст кроме поста (рассуждения и т.д.)

Каждый твой ответ - полный пост, не его отредактированная часть, а полный текст поста!

<b>Пример выжимки (не шаблон, а лишь пример):</b>  
<blockquote>  
...
Обязательно вначале напиши проблематику и сделать пост более подробным.
"""
