...
async def handle_profile_command(message: Message):
    ...
    try:
        ...
        await message.answer(
            PROFILE_MSG, reply_markup=builder.as_markup(), parse_mode="HTML"
        )
...
async def handle_check_subscription(callback: CallbackQuery):
    ...
    try:
        ...
        has_subscription = (
            await check_subscription_route_subscription_check_get.asyncio(
        ...
        if has_subscription:
            ...
            await callback.message.edit_text(
                SUBSCRIPTION_INFO_MSG.format(status=status, expires_at=expires_at),
                parse_mode="HTML",
            )
        else:
            await callback.message.edit_text(NO_SUBSCRIPTION_MSG, parse_mode="HTML")
