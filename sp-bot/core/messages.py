...
Здесь вы можете добавить новые источники или посмотреть текущие. Я буду проверять их раз в день и присылать свежие статьи!"""
...
INVALID_SOURCE_MSG = """❌ <b>Неверная ссылка</b>

Пожалуйста, укажите корректный RSS или URL сайта."""
