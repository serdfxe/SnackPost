...
class PageContentExtractor:
    ...
    def _process_links(self, links_data, base_url):
        ...
        if not links_data or 'links_texts' not in links_data or 'link_urls' not in links_data:
            return result
    ...
    def get_page_content(self, url, as_markdown=True):
        ...
        try:
            ...
            if not as_markdown:
                ...
                if response.status_code == 200 and len(response.text) > 15000:  # Simple check if content is OK
    ...
    def extract_links(self, url):
        ...
        try:
            ...
            if links_data and len(links_data.get('link_urls', [])) > 20:  # Minimum links threshold
